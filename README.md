...
- **Configurable** — refresh interval, label format (5h/7d, 5h-only, 7d-only, max-of-all), thresholds, terminal command.
...
|---|---|---|
| Refresh interval | 60 s | How often to poll `/api/oauth/usage`. |
